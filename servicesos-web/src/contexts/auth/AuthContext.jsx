...
/**
 * Auth + Tenant Context
 * Shared authentication and authorization across all SaaS platforms
 *
 ...
 * }
 *
 * FIRESTORE TENANT DOC (tenants/{tenantId})
 */
...
import { auth, googleProvider, db } from '../../servicesos-web/src/firebase';
import { setCurrentTenantId, clearCurrentTenantId } from '../../servicesos-web/src/services/multiTenantService';
import { getTenant } from '../../servicesos-web/src/services/tenantService';
